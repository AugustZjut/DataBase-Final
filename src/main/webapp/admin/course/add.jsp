...
<form action="${pageContext.request.contextPath}/admin/course" method="post">
    ...
    <label>课程名称：<input type="text" name="kcmc" required /></label>
    <label>学分：<input type="text" name="xf" required /></label>
    <label>开课学期：<input type="text" name="kkxq" /></label>
    <label>学时：<input type="text" name="xs" /></label>
    <label>课程类型：<input type="text" name="ksfs" /></label>
