...
<form action="${pageContext.request.contextPath}/admin/teacher" method="post">
    ...
    <label>工号：<input type="text" name="jsbh" required /></label>
    <label>姓名：<input type="text" name="jsxmc" required /></label>
    <label>性别：<input type="text" name="jsxb" /></label>
    <label>职称：<input type="text" name="jszc" /></label>
    <label>联系方式：<input type="text" name="jslxdh" /></label>
    <label>出生日期：<input type="text" name="jscsrq" placeholder="yyyy-mm-dd" required /></label>
